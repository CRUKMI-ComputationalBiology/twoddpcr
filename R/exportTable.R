...
setMethod("exportTable", "data.frame",
  function(theObject, location, delim=",", leadingColName=NULL, row.names=TRUE)
  {
...
setMethod("exportTable", "ddpcrWell",
...
setMethod("exportTable", "ddpcrPlate",
